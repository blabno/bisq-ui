...
export class CurrencyComponent implements OnInit, OnDestroy {
  ...
  formMap = {
    ...
    SAME_BANK: {
      ...
      limitations: {
        type: 'footer', label: t('ACCOUNT.CURRENCY.LIMITATIONS'),
        text: t('ACCOUNT.CURRENCY.LIMITATION_2_0625_0')
      }
    },
    SEPA: {
      holderName: {
    ...
    SPECIFIC_BANKS: {
      ...
      acceptedBanks: {
        type: 'text', label: t('ACCOUNT.CURRENCY.ACCEPTED_BANKS_ID'),
        validators: ['required']
      },
      holderName: {
        type: 'text', label: t('ACCOUNT.CURRENCY.OWNER_NAME'),
    ...
    WESTERN_UNION: {
      ...
      holderName: {
        type: 'text', label: t('ACCOUNT.CURRENCY.FULL_NAME'),
        validators: ['required']
      },
      city: {
        type: 'text', label: t('ACCOUNT.CURRENCY.CITY'),
        validators: ['required']
      },
      email: {
        type: 'text', label: t('ACCOUNT.CURRENCY.EMAIL'),
